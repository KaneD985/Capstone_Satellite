...
void loop() {
  ...
  readAllAccel();             
    ...
    Serial.print("acc_x:");
    Serial.print(signed_acc_x);
    Serial.print("\tacc_y:");
    Serial.print(signed_acc_y);
    Serial.print("\tacc_z:");
  ...
  //   dataFile.println(signed_gyr_z);a
  //   dataFile.close();
  // }  
  // else {
  //   Serial.println("error opening datalog.txt");
  ...
  // bool writeResult = CANbus.write(FR_BRAKE_TEMP) & CANbus.write(FR_TIRE_TEMP) & 
                     // CANbus.write(FR_ANALOG) & CANbus.write(FR_ACC) & CANbus.write(FR_GYR);
  ...
  bool writeResult = CANbus.write(FL_BRAKE_TEMP) & CANbus.write(FL_TIRE_TEMP) & 
                     CANbus.write(FL_ANALOG) & CANbus.write(FL_ACC) & CANbus.write(FL_GYR);
  ...
  // bool writeResult = CANbus.write(RL_BRAKE_TEMP) & CANbus.write(RL_TIRE_TEMP) & 
                     // CANbus.write(RL_ANALOG) & CANbus.write(RL_ACC) & CANbus.write(RL_GYR);
  ...
  // bool writeResult = CANbus.write(RR_BRAKE_TEMP) & CANbus.write(RR_TIRE_TEMP) & 
                     // CANbus.write(RR_ANALOG) & CANbus.write(RR_ACC) & CANbus.write(RR_GYR);
